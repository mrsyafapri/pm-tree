...
public class TreeApp {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            System.out.print("Enter first letter of show, " + "insert, find, delete, max(x), min(n) or traverse: ");
            int choice = getChar();
            switch (choice) {
                case 's':
                    theTree.displayTree();
                ...
                case 't':
                    ...
                    break;
                case 'x':
                    int max = theTree.findMax(theTree.getRoot());
                    System.out.println("Maximum value = " + max);
                    break;
                case 'n':
                    int min = theTree.findMin(theTree.getRoot());
